            ...
            <?php echo $this->session->flashdata('msg') ?>
              ...
              <div class="tab-content">
                <div class="tab-pane active" id="register">
                  ...
                  <!--Register Form-->
                  <form name="registration_form" id='registration_form' class="form-inline" action="<?php echo base_url(); ?>account/doctor_register" method="post" enctype="multipart/form-data">
                    <div class="row">
                      <div class="form-group col-xs-6">
                        <label for="firstname" class="sr-only">First Name</label>
                        <span class="text-danger"><?php echo form_error('fname'); ?></span>
                        <input id="firstname" class="form-control input-group-lg" type="text" name="fname" title="Enter first name" placeholder="First name" value="<?php echo set_value('fname'); ?>" required="" />
                      </div>
                      <div class="form-group col-xs-6">
                        <label for="lastname" class="sr-only">Last Name</label>
                        <span class="text-danger"><?php echo form_error('lname'); ?></span>
                        <input id="lastname" class="form-control input-group-lg" type="text" name="lname" title="Enter last name" placeholder="Last name" value="<?php echo set_value('lname'); ?>" required="" />
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="form-group col-xs-12">
                        ...
                        <span class="text-danger"><?php echo form_error('specialization'); ?></span>
                         <select class="form-control" name="specialization" id="month" required="">
